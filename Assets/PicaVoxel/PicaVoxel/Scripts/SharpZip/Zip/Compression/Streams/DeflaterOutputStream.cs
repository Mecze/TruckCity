...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	public class DeflaterOutputStream : Stream
	{
		...
		uint[] keys;
#else
		ICryptoTransform cryptoTransform_ = null;
...
//#endif
		...
		{
			keys[0] = ICSharpCode.SharpZipLib.Checksums.Crc32.ComputeCrc32(keys[0], ch);
			keys[1] = keys[1] + (byte)keys[0];
			keys[1] = keys[1] * 134775813 + 1;
			keys[2] = ICSharpCode.SharpZipLib.Checksums.Crc32.ComputeCrc32(keys[2], (byte)(keys[1] >> 24));
		}
#endif
